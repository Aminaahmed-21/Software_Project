...
class Movie_Critic_Review_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Movie_Critic_Review_About_Widget',
			__('VW About us', 'movie-critic-review'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'movie-critic-review' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','movie-critic-review'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','movie-critic-review'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','movie-critic-review'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','movie-critic-review'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','movie-critic-review'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','movie-critic-review'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function movie_critic_review_about_custom_load_widget() {
	register_widget( 'Movie_Critic_Review_About_Widget' );
}
add_action( 'widgets_init', 'movie_critic_review_about_custom_load_widget' );